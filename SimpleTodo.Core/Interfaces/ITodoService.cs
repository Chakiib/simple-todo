...
public interface ITodoService
{
    ...
    Task<TodoItem> CreateTodoAsync(TodoItem todoItem, CancellationToken cancellationToken = default);
    Task<TodoList?> UpdateTodoAsync(TodoItem todoItem, CancellationToken cancellationToken = default);
